                ...
                >
                  ...
                  <div className="flex-1 overflow-y-auto px-6 py-6 sm:px-8 border-t border-border/10">
                    <div className="flex flex-col gap-8">
                      {activePendingApproval.attachments &&
                        activePendingApproval.attachments.length > 0 && (
                          <div className="mb-2">
                            <UpdateAttachmentsList
                              attachments={activePendingApproval.attachments}
                            />
                          </div>
                        )}
                      ...
                      <div className="flex flex-col gap-6">
                        ...
                        <div className="space-y-4">
                          ...
                          <Button
                            ...
                            disabled={
                              isRejecting || feedback.trim().length < 10
                            }
                            variant="outline"
