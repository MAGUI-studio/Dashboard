...
interface ClientHeroStatusProps {
  userName: string
  status: "on_track" | "awaiting_approval" | "need_shipment" | "briefing_incomplete"
}

export async function ClientHeroStatus({ userName, status }: ClientHeroStatusProps): Promise<React.JSX.Element> {
  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-2.5">
        <div className={`size-1.5 animate-pulse rounded-full ${currentStatus.color}`} />
